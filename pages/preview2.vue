<template>
  ...
  import { toPng } from "html-to-image"; // Removed unnecessary imports
  export default {
    setup() {
      ...
      const handleImageUpload = (event) => {
        ...
        reader.onload = (e) => {
          ...
          img.onload = () => {
            ...
            // Automatically save the uploaded image after handling the upload
            saveImage();
          };
        };
      ...
      const resetImage = () => {
        ...
        // Automatically save and download when resetting the image
      };
