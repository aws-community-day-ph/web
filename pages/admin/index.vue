    ...
    <div class="main">
        ...
        <div class="left-wrapper">
            ...
            <div v-if="selectedRequestID" class="req-container">
                <TopContainer />
                <div class="del-cont">
                    <DeleteRequest :selectedRequestID="selectedRequestID"/>
                </div>
                <div class="get-status">
                    <Status :status="getStatusForSelectedRequest"></Status>
                    <RequestID :requestID="selectedRequestID" class="req-id"
                        >h3</RequestID
                    >
                    <PointPerson
                        :pointPerson="getPointPerson"
                        class="p-person"
                    ></PointPerson>
                </div>
                <EmailList
...
import PointPerson from "@/components/adminpage/RightPanel/PointPerson";
...
export default {
    ...
    setup() {
        ...
        const getPointPerson = computed(() => {
            if (selectedRequestID.value !== null) {
                const selectedRequest = allRequests.value.find(
                    (request) => request.requestId === selectedRequestID.value
                );
                return selectedRequest ? selectedRequest.pointPerson : null;
            }
            return null;
        });
